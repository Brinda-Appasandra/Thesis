...
if __name__ == "__main__":
    ...
    # Use the shared secret as the AES key - for AES-256 we need 32 bytes
    aes_key = shared_key_alice[:32]  # Use first 32 bytes for AES-256
    write_to_file('keys/aes_key.bin', aes_key)
    print("AES-256 key derived from DH shared secret and saved to keys/aes_key.bin")
