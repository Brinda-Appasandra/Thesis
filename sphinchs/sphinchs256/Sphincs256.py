...
if __name__ == "__main__":
    ...
    # AES-256 key generation (32 bytes for AES-256)
    aes_key = get_random_bytes(32)  # AES-256 key
    write_to_file('keys/aes_key.bin', aes_key)
    print("AES-256 key written to keys/aes_key.bin")
    ...
    for i, row in enumerate(rows):
        ...
        print(f"Row {i}: AES-256 ciphertext, signed message, and decrypted message written to respective files")
