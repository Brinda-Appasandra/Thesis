...
def plot_standard_deviation(std_devs):
    ...
    plt.title('Standard Deviation of Total Time for Different Data Sizes for Falcon (aes128)')
    plt.grid(True)
    ...
    plt.savefig('total_time_stddev_plot.png')  
    print("Plot saved as total_time_stddev_plot.png")
