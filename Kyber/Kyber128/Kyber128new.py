...
if __name__ == "__main__":
    ...
    for i, row in enumerate(rows):
        ...
        # Encapsulate shared secret using Kyber512, passing the public key as argument
        ...
        # Derive AES-128 key from the shared secret (using the first 16 bytes)
        aes_key = shared_secret_enc[:16]
        ...
        aes_key_dec = shared_secret_dec[:16]
